...
<script>
  ...
  // const bannerWave1 =  require('@/assets/pic/bannerWave1.png');
  // const bannerWave2 =  require('@/assets/pic/bannerWave2.png');
  // const fontWoff2 =  require('@/assets/fonts/font.woff2');
  const qiniuResourcePrefix = 'http://sj9nja7mg.hd-bkt.clouddn.com/resource/'
  export default {
    data() {
      return {
        toolButton: false,
    ...
    methods: {
      ...
      buildCssPicture() {
        ...
        root.style.setProperty("--bannerWave1", `url(${qiniuResourcePrefix}/pic/bannerWave1.png) repeat-x`);
        root.style.setProperty("--bannerWave2", `url(${qiniuResourcePrefix}/pic/bannerWave2.png) repeat-x`);
        ...
        const font = new FontFace("web-font", `url(${qiniuResourcePrefix}/font/font.woff2)`);
        font.load();
